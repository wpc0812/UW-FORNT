            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="员工代码:" prop="userCode">
                  <el-input v-model="rtReported.userCode"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="自动分发标志:">
                  <el-select v-model="relations.value" clearable placeholder="请选择">
                    <el-option
              ...
              <el-col :span="24" class="text-center">
                <el-button size="mini" @click="outerVisible  = true">增加</el-button>
              </el-col>
            </el-row>
          </el-form>
        </el-collapse-item>
...
export default {
  ...
  created() {
      this.ruleForm();
      this.rtReported.userCode=this.$route.query.code
  }
};
</script>
<style scoped>
