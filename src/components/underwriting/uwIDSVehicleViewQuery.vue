                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item label="关系人代码:">
                      <el-input v-model="peifulv.customerCodeT"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
        ...
        <el-collapse v-model="activeNames">
          <el-collapse-item name="1">
            ...
            <el-table :data="resultCustomerList1" style="width: 100%">
              ...
              <el-select v-model="scope.row.bizciflag" size="mini" placeholder="请选择" style="width:100px;">
...
export default {
  ...
  methods: {
          //客户查询
    query() {
        this.$fetch.post(this.HOST + this.$url.uwIDSVehicleViewQuerySelect, this.peifulv)
      .then(res=>{
        this.resultCustomerList1=res.uwIdsClientEleList[0].i_APP_3YEAR_CUST_PAYMENT_RATE1_REAL_LIST
         this.resultCustomerList2=res.uwIdsClientEleList[0].i_PLC_PRPCMAIN_LIST
        // i_PLC_PRPCMAIN_LIST
        // console.log(res.uwIdsClientEleList[0].i_APP_3YEAR_CUST_PAYMENT_RATE1_REAL_LIST)
      })
    },
    //标的车查询
    query1() {
      this.$fetch.post(this.HOST + this.$url.uwIDSVehicleViewQuerySelect, this.peifulv1)
      .then(res=>{
