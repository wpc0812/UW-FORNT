      ...
      <el-card class="circular mt4 shadow">
        <el-collapse v-model="activeNames">
          <el-collapse-item name="3">
            ...
            <div v-for="(flowRecord,index) in underwritingDetails.flowRecords" 
             :key="index" :class="(index + 1) == underwritingDetails.flowRecords.length ? '' : 'border-btm-gra'">
              <el-row :gutter="20">
                <el-col :span="24">
                ...
                <el-col :span="8">
                  <el-form-item label="节点名称:">
                    <el-input v-model="flowRecord.curFlow">
                    </el-input>
