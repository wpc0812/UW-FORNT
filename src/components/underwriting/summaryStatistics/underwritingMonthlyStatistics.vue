...
export default {
  name: "underwritingMonthlyStatistics",
  components: {
  },
  data() {
    return {
  ...
  methods: {
    //导出
     exportFile() {
      let url = this.HOST + this.$url.exportArtificialUnderwriteTraffic
      utils.axiosDown(url,this.monthly)
    }
  },
  created() {}
};
