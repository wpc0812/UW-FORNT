<template>
  <div class="titlestyleauto">
    ...
    <el-form :model="underwritingDetails" class= "elform" label-width="185px">
      <!-- 处理核保任务 -->
        ...
        <el-collapse v-model="activeNames">
          <el-collapse-item name="13">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="定价返回的跟单风险保费合计:">
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="不考虑模拟交强的销售费用率:">
      ...
      <el-card class="circular mt4 shadow">
        <el-collapse v-model="activeNames">
          <el-collapse-item name="15">
            ...
            style="width: 100%"
            :cell-style="{'text-align': 'center'}"
            :header-cell-style="{'text-align': 'center' ,'color': '#303133'}"
            :header-cell-class-name="'table-header-bg'"
          >
            <el-table-column align="center" prop="num"  label="序号"></el-table-column>
            <el-table-column align="center" prop="numto" label="特约序号"></el-table-column>
            <el-table-column align="center" prop="numcon" label="特约内容"></el-table-column>
          </el-table>
          </el-collapse-item>
        </el-collapse>
      </el-card>
    ...
    <!-- dialog弹出框 -->
    <el-dialog title="核保任务提交" class="text-left"  :lock-scroll="false" :visible.sync="outerVisible">
      <div id="form">
    ...
    <el-dialog class="el-dialog__body__update" width="40%" title="核保任务提交" :visible.sync="innerVisible">
