    ...
    <el-card class="circular mt4 shadow">
      <el-collapse v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <el-form label-width="170px" v-if="flag" :rules="formData">
            <el-row>
              <el-row>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="控制关系人标志:" prop="controlpeo">
                    <el-select v-model="rtAdd.value" clearable placeholder="被保险人">
                      <el-option
                ...
                <el-col :span="8">
                  <el-form-item label="控制关系人名称:" prop="controlname">
                    <template>
                      <el-input class="peoCode" v-model="rtAdd.vesselName"></el-input>
                      <el-button @click="selectName" class="selectCode">查找</el-button>
                    </template>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item label="控制关系人代码:" prop="controlcode">
                    <template>
                      <el-input class="peoCode" v-model="rtAdd.vesselName"></el-input>
                      <el-button @click="selectCode" class="selectCode">查找</el-button>
                    </template>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="业务来源:" class="text-left" prop="sourcebusiness">
                    <el-select v-model="rtAdd.value" clearable placeholder="新车车队">
                      <el-option
                        v-for="relation in relations"
                        :key="relation.code"
                        :label="relation.value"
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item label="预估保费规模(单位:万元):" prop="premiumsize" class="text-left">
                    <el-input v-model="rtAdd.vesselName"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="涉及车籍地:" prop="carplace">
                    <el-input v-model="rtAdd.vesselName" placeholder="点击选择"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
